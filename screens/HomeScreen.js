...
export default function HomeScreen() {
  ...
  const bgLocation = useBackgroundLocation(verificarZonas);
  ...
  useEffect(() => {
    if (!bgIniciado.current && !permisoDenegado && location) {
      bgIniciado.current = true;
      bgLocation.iniciar().catch(() => {});
    }
  }, [permisoDenegado, location]);
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity
        ...
        activeOpacity={0.8}
        accessibilityLabel="Abrir números de emergencia"
      >
